...
const JadwalOpen = ({nama,game,alias,ligaId}) => {
    ...
    return(
        <div>
            <div className='bg-red-600 py-2 px-4 sticky top-12 flex items-center border-b border-white cursor-pointer z-20' onClick={()=>setOpen(!open)} id={ligaId}>
